    ...
    <section id="hero" class="hero">
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-6">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('news') }}">Відгуки</a></li>
                ...
                <div class="col-12 col-md-6 text-center"><img class="img-fluid" src="{{ asset('img/healing.jpg') }}" alt="{{ $news->name }}" title="{{ $news->name }}"> </div>
            </div>
        </div>
    </section>
