    ...
    <div class="container">
        <div class="row align-items-start">
            <div class="col col-md-3 col-sm-3">
                <p><i class="fa-solid fa-clock"></i> График работы: круглосуточно</p>
            </div>
            <div class="col col-md-3 col-sm-3">
                <p><i class="fa-solid fa-location-dot"></i> г. Житомир, Чудновское шоссе 1</p>
            </div>
...
<div class="container">
    <div class="row">
        <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-1 mb-2">
            <div class="col col-md-auto"><a href="{{ route('ro') }}" title="Healing - часная клиника, Житомир"><img
                        src="{{ asset('/img/LOGO1.jpg') }}" class="logo" alt="Healing - часная клиника, Житомир"></a>
            </div>

            @include('app.includes.nav_ro')
            <div class="col-md-8 col-lg-5 d-md-flex d-none d-sm-none">
                <a href="{{ route('child') }}" type="button"
                   class="btn btn-success py-md-2 px-md-2 px-sm-2 px-lg-4 my-md-0 my-sm-2 ">Клиника "Здоровый
                    Ребенок"</a>
                <a href="#appointment" type="button" class="btn btn-info py-md-2 px-md-2 px-lg-4 px-sm-2 mx-md-3">Записатся
