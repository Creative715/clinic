...
@section('content')
    ...
    <section id="hero" class="hero">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 text-center"><img class="img-fluid" src="{{ $pageros->img }}"
                                                              alt="{{ $pageros->seo_title }}"
                                                              title="{{ $pageros->seo_title }}"></div>
            </div>
        </div>
    </section>
    <section id="page" class="page">
        <div class="container">
            <div class="row">
                <a href="{{ url('/ru/chastnaia-skoraia-pomosch') }}" type="button"
                   class="btn btn-success py-3 text-uppercase"><h4 style="color: #fff">Частная скорая помощь <i
